package com.sookcs.loadingandpullrefreshandtab.viewtype;
...
import com.sookcs.loadingandpullrefreshandtab.R;
import com.sookcs.loadingandpullrefreshandtab.utils.DensityUtil;
...
public class ProgressActivity extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        loadingStateProgressBarWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_loadingProgressBarWidth, DensityUtil.dip2px(getContext(), 120));

        loadingStateProgressBarHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_loadingProgressBarHeight, DensityUtil.dip2px(getContext(), 100));
    ...
    private void setLoadingView() {
        if (loadingStateRelativeLayout == null) {
            ...
            if (android.os.Build.VERSION.SDK_INT > 22) {//android 6.0替换clip的加载动画
                final Drawable drawable = mContext.getApplicationContext().getResources().getDrawable(R.drawable.common_loading_anim_up6_);
