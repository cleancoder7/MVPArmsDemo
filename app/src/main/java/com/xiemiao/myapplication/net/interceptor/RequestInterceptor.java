package com.xiemiao.myapplication.net.interceptor;
...
public class RequestInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (logRequest) {
            ...
            //打印请求信息
            Timber.tag(getTag(request, "Request_Info")).i("Params : 「 %s 」%nConnection : 「 %s 」%nHeaders : %n「 %s 」"
        ...
        if (logResponse) {
            ...
            //打印响应时间以及响应头
            Timber.tag(getTag(request, "Response_Info")).i("Received response in [ %d-ms ] , [ %s ]%n%s"
    ...
    private String printResult(Request request, Response response, boolean logResponse) throws IOException {
        ...
        if (isParseable(responseBody.contentType())) {
            ...
            if (logResponse) {
                Timber.tag(getTag(request, "Response_Result")).i(isJson(responseBody.contentType()) ?
            ...
            if (logResponse) {
                Timber.tag(getTag(request, "Response_Result")).i("This result isn't parsed");
            }
        }
        return bodyString;
    }
