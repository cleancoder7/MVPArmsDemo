/**
 * Project Name:ShiShuo File Name:NumMatchUtil.java Package
 * Name:com.sookcs.shishuo.utils Date:2017年2月28日下午6:27:31 Copyright (c) 2017,
 * 武汉掌联 All Rights Reserved.
 * 
 */
...
//	static String DX = "^[1]{1}(([3]{1}[3]{1})|([5]{1}[3]{1})|([8]{1}[09]{1}))[0-9]{8}$";
	static String DX = "^((13[0-9])|(15[^4,\\D])|(14[57])|(17[0])|(17[7])|(18[0,0-9]))\\d{8}$";//支持虚拟运营商170号段,177
	String mobPhnNum;

	public NumMatchUtil(String mobPhnNum)
	{
	...
	public int matchNum()
	{
		...
		if (mobPhnNum.length() == 11)
		{
			...
			// 判断手机号码是否符合中国联通的号码规则
				...
				if (mobPhnNum.matches(LT))
				{
					flag = 2;
				}
				// 判断手机号码是否符合中国电信的号码规则
				else
					if (mobPhnNum.matches(DX))
					{
						flag = 3;
					}
					// 都不适合，未知֪
	...
	public static boolean isValidPhoneNumber(String number)
	{
		boolean flag = false;
		if (number.length() == 11
				&& (number.matches(YD) || number.matches(LT) || number.matches(DX)))
		{
			flag = true;
		}
		return flag;
